...
\begin{frame}[fragile,t]
\frametitle{Reasonable strlen disassembly}
...
\begin{frame}[fragile,t]
\frametitle{glibc strlen disassembly}
Let's compile and disassemble it.\vs
\begin{customobjdumpcode}
...
# it easy to specify destination addresses for jumps
label1:
label2:
  movl $0, %eax   # %eax = 0
...
addl $8, %eax       # Deallocate 8 bytes off of the stack
