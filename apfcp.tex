...
\end{gascode}
\begin{textcode}
$ as example-20.S -o example-20.o && ld example-20. o -o example-20
$ ./example-20
Hello!$
\end{textcode}
\end{frame}
...
$ as example-21.S -o example-21.o && ld example-21.o -o example-21
$ ./example-21
Hello!$
\end{textcode*}
\end{frame}
...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \item Modify exploit shellcode to print a newline ({\ttfamily example-21.S})
  \end{itemize}
