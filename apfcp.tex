...
\begin{frame}[fragile,t]
\frametitle{Example of Conditional Jumps (example-cond-jmp.S)}
\mvs
\begin{gascode}
.section .text
  # cmpl %oper1, %oper2
...
\begin{frame}[fragile,t]
\frametitle{Example of Conditional Jumps (example-cond-jmp.S) Continued}
\mvs
\begin{gascode}
...
\begin{frame}[fragile,t]
\frametitle{Example of Conditional Jumps (example-cond-jmp.S) Disassembly}
\mvs
\begin{customobjdumpcode}
$ as example-cond-jmp.S -o example-cond-jmp.o &&
   ld example-cond-jmp.o -o example-cond-jmp && objdump -D example-cond-jmp
...
\begin{frame}[fragile,t]
\frametitle{Example of Conditional Jumps (example-cond-jmp.S) Disassembly Continued}
\mvs
\begin{customobjdumpcode}
0804806c <label1>:
...
\begin{frame}[fragile,t]
\frametitle{Example of Static Allocation in Assembly (example-static-alloc.S)}
\mvs
\begin{gascode}
...
\begin{frame}[fragile,t]
\frametitle{Example of Static Allocation in Assembly (example-static-alloc.S) Disassembly}
\mvs
\begin{customobjdumpcode}
$ as example-static-alloc.S -o example-static-alloc.o &&
   ld example-static-alloc.o -o example-static-alloc && objdump -D example-static-alloc
...
$ as example-stack.S -o example-stack.o &&
   ld example-stack.o -o example-stack && objdump -D example-stack
...
\begin{figure}
\centering
\includegraphics[width=0.65\textwidth]{figures/stackframe.png}
\end{figure}
\end{frame}
...
\begin{frame}[fragile,t]
\frametitle{Example of System Calls (example-syscall.S) Runtime}
\mvs
\begin{textcode}
...
\begin{frame}[fragile,t]
\frametitle{Example of System Calls (example-syscall.S) Disassembly}
\mvs
\begin{customobjdumpcode*}{textsize=\textsize{9}{8}}
$ as example-syscall.S -o example-syscall.o &&
   ld example-syscall.o -o example-syscall && ojbdump -D example-syscall
...
\section{Advanced Topic 11: x86 String Operations}
