...
\begin{itemize}
    ...
    \vs
    \pause
    \item Sufficient expressability of instructions makes a CPU Turing complete, \\ provided you have infinite memory
\end{itemize}
\end{frame}
...
\begin{itemize}
    ...
    \vs
    \pause
    \item Fetch - Decode - Execute Loop
    \begin{itemize}
...
\begin{itemize}
  ...
  \item x86 stack is {\bf last in first out}, {\bf descending}, and \\ {\ttfamily \%esp} points to allocated memory
