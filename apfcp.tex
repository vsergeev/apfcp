...
\begin{frame}[fragile,t]
\frametitle{Example of Static Allocation in Assembly (example-4.S)}
\mvs
\begin{gascode}
...
\begin{frame}[fragile,t]
\frametitle{Example of Static Allocation in Assembly (example-4.S) Disassembly}
\mvs
\begin{customobjdumpcode}
$ as example-4.S -o example-4.o && ld example-4.o -o example-4 &&
   objdump -D example-4
...
example-4:     file format elf32-i386
example-4
...
\begin{frame}[fragile,t]
\frametitle{Example of System Calls (example-9.S) Runtime}
\mvs
\begin{textcode}
$ as example-9.S -o example-9.o
$ ld example-9.o -o example-9
$ ./example-9
$ cat foo
Hello World!
$
...
\begin{frame}[fragile,t]
\frametitle{Example of System Calls (example-9.S) Disassembly}
\mvs
\begin{customobjdumpcode*}{textsize=\textsize{9}{8}}
$ as example-9.S -o example-9.o && ld example-9.o -o example-9 &&
   ojbdump -D example-9
...
\begin{frame}[fragile,t]
\mvs
\frametitle{Example 1 of String Instructions (example-10.S)}
\begin{gascode}
_start:
...
\begin{frame}[fragile,t]
\mvs
\frametitle{Example 1 of String Instructions (example-10.S) Continued}
\begin{gascode}
.section .bss
  .comm str1, 8
  .comm str2, 8
...
\vs
\begin{textcode}
$ gcc -fno-stack-protector -z execstack example-insecure.c -o example-insecure
\end{textcode}
\begin{itemize}
...
\end{gascode}
\begin{textcode}
$ as example-shellcode1.S -o example-shellcode1.o && ld example-shellcode1. o -o example-shellcode1
$ ./example-shellcode1
Hello!$
\end{textcode}
\end{frame}
...
$ as example-shellcode2.S -o example-shellcode2.o && ld example-shellcode2.o -o example-shellcode2
$ ./example-shellcode2
Hello!$
\end{textcode*}
\end{frame}
